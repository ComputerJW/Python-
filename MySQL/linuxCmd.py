...
touch -c filname : filename의 시간을 션재 시간으로 갱신
touch -t 20221110142038 filename :
        filename의 시간을 날짜정보 (YYYYMMDDhhmm) 으로 갱신
...
7   111 rwx 모든 권한 있음
예를 들어 '777'의 경우 이진수로 111111111 이고
rwxrwxrwx라는 의미를 가지므로 파일 소유자, 소유 그룹, 일반 사용자에게 읽기, 쓰기, 실행의 모든 권한을 주는 설정이다.
...
8. cat (Catenate) : 파일의 내용을 화면에 출력, 리다이렉션 기호 ('>')을 사용하여 새로운 파일 생성
cat file1 : file1의 내용을 출력
cat file1 file2 : file1 과 file2 의 내용을 출력
cat file1 file2 | more : file1 과 file2의 내용을 페이지별로 출력
cat file1 file2 | head : file1과 file2의 내용을 처음부터 10번째 줄까지만 출력
cat file1 file2 | tail : file1과 file2의 내용을 끝에서부터 10번째 줄까지만 입력
